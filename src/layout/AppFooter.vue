    ...
    <footer class="footer has-cards">
        ...
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                <div class="col-lg-6">
                    <h3 class="text-primary font-weight-light mb-2">Kantor internetowy
                      inny niż wszystkie!</h3>
                    <h4 class="mb-0 font-weight-light">Dołącz do największej społecznościowej platformy
                      wymiany walut w Polsce i oszczędź do 8%.</h4>
                </div>
